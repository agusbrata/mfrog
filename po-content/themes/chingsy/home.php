...
<div class="section header-stick bottommargin-lg clearfix" style="padding: 8px 0;">
	<div>
		<div class="container clearfix">
			<span class="label label-danger bnews-title"> <!-- <?=$this->e($front_breaking_news);?> --> M-FROG News:</span>
...
<div class="container clearfix">
	<div class="container clearfix">
	<h4 text style=" text-align: center; font-size: 24px; color: #000080;"><i> "Lakukan Banyak Hal Dengan Uang Anda"</span></h4></i>
	
	<table>
		<tbody>
		  <tr>
			   <td style="width: 674.667px; height: 334px;">
				<p><img src="http://localhost:88/mfrog/po-content/uploads/tes2.JPG" alt="m-frog 2" width="350" height="300"/></p>
				<form><input style="width: 350px; padding: 10px; cursor: pointer; box-shadow: 6px 6px 5px; #999; -webkit-box-shadow: 6px 6px 5px #999; -moz-box-shadow: 6px 6px 5px #999; font-weight: bold; background:#FFCC00; color: #000; border-radius: 10px; border: 1px solid #999; font-size: 100%;" type="button" value="Ajukan Pendanaan Project" onclick="window.location.href='http://localhost:88/mfrog/pendanaanproject'" />
				</form></td>
			   
			   <td style="width: 674.667px; height: 334px;">
				<p><img src="http://localhost:88/mfrog/po-content/uploads/tes.JPG" alt="m-frog 2" width="350" height="300"/></p>
				<form><input style="width: 350px; padding: 10px; cursor: pointer; box-shadow: 6px 6px 5px; #999; -webkit-box-shadow: 6px 6px 5px #999; -moz-box-shadow: 6px 6px 5px #999; font-weight: bold; background:#CC0000; color: #FFFFFF; border-radius: 10px; border: 1px solid #999; font-size: 100%;" type="button" value="Ajukan Pinjaman Bisnis" onclick="window.location.href='http://localhost:88/mfrog/pinjamanbisnis'"/>
				</form></td>
		   
			   <td style="width: 674.667px; height: 334px;">
				<p><img src="http://localhost:88/mfrog/po-content/uploads/tes3.JPG" alt="m-frog 2" width="350" height="300"/></p>
				
				<form>
				<input style="width: 350px; padding: 10px; cursor: pointer; box-shadow: 6px 6px 5px; #999; -webkit-box-shadow: 6px 6px 5px #999; -moz-box-shadow: 6px 6px 5px #999; font-weight: bold; background:#330066; color: #FFFFFF; border-radius: 10px; border: 1px solid #999; font-size: 100%;" type="button" value="Berikan Investasi" onclick="window.location.href='http://localhost:88/mfrog/investor'" />
				</form>
		  </tr>
		</tbody>
	</table>	
