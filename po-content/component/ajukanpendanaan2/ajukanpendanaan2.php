 ...
 *
*/
$router->match('GET|POST', '/ajukanpendanaan2', function() use ($core, $templates) {
	$alertmsg = '';
	$lang = $core->setlang('ajukanpendanaan2', WEB_LANG);
	if (!empty($_POST)) {
	...
	$info = array(
		'page_title' => $lang['ajukanpendanaan2'],
	...
	echo $templates->render('ajukanpendanaan2', compact('lang'));
});
