		...
		<div class="col_half fright col_last nobottommargin">
			<div id="top-social">
				<ul>
					...
					<li><a href="javascript:void(0)" class="si-twitter"><span class="ts-icon"><i class="icon-headphones"></i></span><span class="ts-text">Pojok Makelar</span></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<header id="header" class="sticky-style-2">
	<div class="container clearfix">
		<div class="">
		<a href='http://localhost:88/mfrog/'>
			<img src="<?=BASE_URL;?>/<?=DIR_CON;?>/uploads/m-forg.jpg" alt="m-forg">
		</a>
		</div>
