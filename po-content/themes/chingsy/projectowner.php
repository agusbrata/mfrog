...
<table id="table-post" class="table table-striped table-bordered" cellpadding="0" cellspacing="0" border="0" width="80%" style="text-align: center;" >
	<body>
	  ...
	  <tr>
		...
		<td class="transparan2" alt="back" width="1000" height="300" background="http://localhost:88/mfrog/po-content/uploads/back5.jpg" style="background-repeat:no repeat; background-position:center; opacity: 0.9; filter: alpha(opacity=90);">
		
		<!-- style="text-align: center;"><img src="http://localhost:88/mfrog/po-content/uploads/back.JPG" alt="back" width="1150" height="500"/> -->
		<br>
		<br>
		<h4 style="color: #ffffff; text-align: left;"> <i> Perlu Tim Work Yang Handal? </i>  <span style="color: #FFFF00; text-align: left;">Percayakan Pada M-FROG</h4>
		...
		<br>
			...
			<form class="nobottommargin" id="template-contactform" name="template-contactform" action="<?=BASE_URL;?>/contact" method="post">
					...
					<div class="col_full">
						<button class="button button-3d nomargin" type="submit" id="template-contactform-submit" name="contact_submit" value="submit" onclick="window.location.href='http://localhost:88/mfrog/member/register'">Ajukan Proyek</button>
						...
						<br>
						<br>
						<h6 style="color: #ffffff; text-align: right;"> *) Pendapatan yang diperoleh dari hasil pengembalian adalah belum termasuk pajak </h6>
					</div>			
