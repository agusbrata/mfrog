...
<table id="table-post" class="table table-striped table-bordered" cellpadding="0" cellspacing="0" border="0" width="80%" style="text-align: center;" >
	<body>
	  ...
	  <tr>
		...
		<td class="transparan2" alt="back" width="1000" height="300" background="http://localhost:88/mfrog/po-content/uploads/back2.JPG" style="background-repeat:no repeat; background-position:center; opacity: 0.9; filter: alpha(opacity=90);">
		
		<!-- style="text-align: center;"><img src="http://localhost:88/mfrog/po-content/uploads/back.JPG" alt="back" width="1150" height="500"/> -->
		<br>
		<br>
		<h3 style="color: #ffffff; text-align: right;"> <i>Pinjaman Tepat Dalam Keadaan Sulit</i> </h3> 
